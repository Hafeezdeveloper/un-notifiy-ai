...
const AddDepartment = () => {
    ...
    const sendAnnouncement = async (e: React.FormEvent) => {
        ...
        try {
            setIsLoading(true);
            const response = await PostApi<any>('/user/create/department', formData);
            ...
            <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-xl">
                <div className="p-6 md:p-8">
                    <div className="mb-6 flex justify-between items-center">
                        <div>
                            <h2 className="text-2xl font-bold text-blue-900">Add Department</h2>
                            <p className="text-sm text-gray-600">Dashboard / Add Department</p>
                        </div>
                        <button
                    ...
                    <div className="space-y-6">
                        <label className="block text-sm font-medium text-gray-700 mb-1">Deprtment Name :</label>
                        <div>
